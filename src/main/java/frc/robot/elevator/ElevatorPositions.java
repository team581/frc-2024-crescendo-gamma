...
public class ElevatorPositions {
  ...
  public static final double OUTTAKING_SHOOTER = 0.0;
  public static final double OUTTAKING_CONVEYOR = 0.0;

  public static final double FLOOR_SHOT = 0.0;

  public static final double SPEAKER_SHOOT = 0.0;

  public static final double SUBWOOFER_SHOT = 0.0;
  public static final double AMP_SHOT = 0.0;

  public static final double CLIMBING = 0.0;
