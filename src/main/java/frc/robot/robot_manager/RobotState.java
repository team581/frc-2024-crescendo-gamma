...
public enum RobotState {
  ...
  PREPARE_SUBWOOFER_SHOT(true, true, false, new LightsState(null, BlinkPattern.SOLID)),
  ...
  PREPARE_SPEAKER_SHOT(true, true, false, new LightsState(null, BlinkPattern.SOLID)),
  ...
  CLIMB_4_HANGING(true, true, false, false, new LightsState(Color.kGreen, BlinkPattern.SOLID)),
